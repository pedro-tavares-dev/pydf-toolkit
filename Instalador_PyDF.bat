...
(
echo @echo off
echo "%PYTHON_REAL%" "%%~dp0juntar_turbo.py" %%*
echo exit
) > "_run_juntar_turbo.bat"
...
call :CriarAtalho "DIVIDIR (PyDF).lnk" "_run_fatiar.bat"
call :CriarAtalho "JUNTAR (PyDF).lnk" "_run_juntar.bat"
call :CriarAtalho "JUNTAR TURBO (PyDF).lnk" "_run_juntar_turbo.bat"
call :CriarAtalho "DIVIDIR SMART (PyDF).lnk" "_run_smart.bat"
call :CriarAtalho "RENOMEAR (PyDF).lnk" "_run_renomear.bat"
